...
12. Demand Forecasting - [Food Demand Forecasting](https://github.com/rthothad/AV/tree/master/GenpactFoodDemandForecasting) – Built a model to predict 10 weeks out demand for meals. Built many interaction features and statistical features such as sum, count, min, max, mean and mode. Dropped non-correlated features and trained a RandomForestRegressor and XGBoost model.  &nbsp;&nbsp;&nbsp;&nbsp;#TimeSeries
